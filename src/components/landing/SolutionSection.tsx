...
export const SolutionSection = () => {
  const features = [
    {
      ...
      description:
        "Let Recap write your daily, weekly, or career recaps in your tone and voice with advanced AI technology.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Task-first Workflow",
      description:
        "Mark tasks as completed, pending, or carried over — all built around daily momentum and productivity.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Linked Notes & Context",
      description:
        "Link multiple tasks to notes. Track insights, lessons, mistakes — all searchable and organized later.",
    },
    {
      icon: <Palette className="w-8 h-8" />,
      title: "Progress Timeline",
      description:
        "See your personal timeline of wins, effort, and growth across time with beautiful visualizations.",
    },
    {
      icon: <Bot className="w-8 h-8" />,
      title: "Portfolio & Resume Ready",
      description:
        "Export professional-style recaps and achievements in one click for career advancement.",
    },
    {
      icon: <Headphones className="w-8 h-8" />,
      title: "24/7 Smart Sync",
      description:
        "Your data syncs across all devices with intelligent backup and version control.",
    },
  ];
  ...
  return (
    <section
      id="features"
      className="py-20  dark:bg-slate-950 transition-colors"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto font-nunito">
            Empowering your workflow with cutting-edge AI tools and intuitive
            functionality.
          </p>
        </div>
